...
},{}],"js/pre-processing.js":[function(require,module,exports) {
(function () {
  splitChars();
})();

function splitChars() {
  var getChars = document.querySelectorAll('[data-split-chars]');
  getChars.forEach(function (el) {
    el.innerHTML = el.textContent.replace(/\S/gm, '<span class="__char" style="display: inline-block;">$&</span>');
  });
}
...
(function () {
  ...
  var titleStroke = document.querySelectorAll('.first-page svg > path');
  var titlefill = document.querySelectorAll('.first-page svg .name-char-fill > path');
  var subtitle = document.querySelectorAll('.first-page h2 .__char');

  _animejs.default.set(titlefill, {
  ...
  var titlesKeyframes = {
    ...
    easing: 'easeInOutExpo' // easing: 'easeOutQuart',
    // easing: 'easeOutBack',
  ...
  tl.add(_objectSpread(_objectSpread({
    targets: [subtitle]
  }, titlesKeyframes), {}, {
    delay: _animejs.default.stagger(150, {
      from: 'center'
  ...
  tl.add(_objectSpread(_objectSpread({
    ...
    delay: _animejs.default.stagger(50, {
      from: 'center'
    })
  }), '-=1100');
...
},{"animejs":"../node_modules/animejs/lib/anime.es.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"animejs":"../node_modules/animejs/lib/anime.es.js","./pre-processing":"js/pre-processing.js","./timeline":"js/timeline.js"}],"C:/Users/narcr/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/narcr/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
