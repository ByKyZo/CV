...
var _preProcessing = require("./pre-processing");
...
},{}],"ffbqW":[function(require,module,exports) {
(function() {
    splitChars();
})();
function splitChars() {
...
},{}],"xi35E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _animejs = require("animejs");
var _animejsDefault = parcelHelpers.interopDefault(_animejs);
...
(function() {
    const tl = _animejsDefault.default.timeline({
        duration: 500,
    ...
    tl.add({
        ...
        duration: 3000,
        strokeDashoffset: [
            _animejsDefault.default.setDashoffset,
            0
        ],
